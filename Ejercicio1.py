...
# Convertir un valor float a una representación binaria
...
# Convertir una cadena binaria a un valor float
...
# Graficar la evolución de las aptitudes
...
# Crear un video a partir de las imágenes de las generaciones
...
def run_genetic_algorithm():
    ...
    # Crear un video con las imágenes generadas de cada generación
